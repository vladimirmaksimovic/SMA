...
<main>
  ...
  <section class="content">
    ...
    <div class="calculation-options">
      <label for="calculations">Избор обрачуна</label>
    ...
    <article class="calculations-container">
      ...
      <div class="calculation-form" id="three-months-calc">
      ...
      <div class="calculation-form" id="six-months-calc">
      ...
      <div class="calculation-form" id="twelve-months-calc">
      ...
      <div class="calculation-form" id="credit-limit">
